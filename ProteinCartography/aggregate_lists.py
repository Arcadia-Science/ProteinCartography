...
def parse_args():
    ...
    parser.add_argument("-i", "--input", required = True, nargs = '+', help = 'Paths of input files. Each file should be a .txt file with one accession per line.')
    parser.add_argument("-o", "--output", required = True, help = 'Path of output file. Duplicates across the lists will be removed.')
