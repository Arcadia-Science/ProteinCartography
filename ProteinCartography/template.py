...
def parse_args():
    ...
    parser.add_argument("-i", "--input", required = True, help = 'Example required argument accepting a single argument.')
    parser.add_argument("-v", "--variable-arg", nargs = '?', default = '', help = 'Example optional argument that accepts 0 or 1 arguments.')
    parser.add_argument("-a", "--arg-list", nargs = '+', default = [], help = 'Example optional argument that accepts 1+ space-separated arguments. By default, returns an empty list.')
...
def main():
    ...
    variable_arg = args.variable_arg #note: dashes in command line arg names are converted to underscores
